...
import survey.common.DeleteInterface;
import survey.common.ListInterface;
import survey.common.ResultStatus;
import survey.common.UpdateInterface;
import survey.common.ViewInterface;
import survey.common.WriteInterface;
...
public class SurveyController {
	...
	public String view(Model model, @RequestParam(value="no",required=true)int no,
		...
		survey = (Survey)viewInterface.process(no,table);
	...
	public String list(Model model,
		...
		List<Survey> surveyList = common.util.GenericConverter.convSurvey(list);
	 ...
	 */
	@RequestMapping(value="/survey/write.do",method=RequestMethod.GET)
	 ...
	 * @return 
	 */
	@RequestMapping(value="/survey/write.do", method=RequestMethod.POST)
	public String write(Model model, 
											RedirectAttributes redirectAttributes, 
											@RequestParam(value="table",required=true)
											String table, Survey inputForm,
											HttpServletRequest request){
		...
		return "redirect:/survey/view.do?no="+resultStatus.getNextNo()+"&table="+table;
	}
